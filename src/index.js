...
async function run() {
  const {
    MONGO_URI, TZ,
    JOB_BLOBS_PENDING, JOB_BLOBS_TRANSFORMED, JOB_BLOBS_ABORTED, JOB_BLOBS_PROCESSING,
    ...
    JOB_FREQ_BLOBS_PENDING, JOB_FREQ_BLOBS_TRANSFORMED, JOB_FREQ_BLOBS_ABORTED, JOB_FREQ_BLOBS_PROCESSING,
    ...
    JOB_BLOBS_TRANSFORMATION_FAILED_CLEANUP
  } = config;
